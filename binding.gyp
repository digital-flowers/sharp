      ...
      ['OS == "win"', {
        ...
        'copies': [{
          ...
          'files': [
             ...
             'lib/iconv.dll',
             'lib/intl.dll',
             'lib/CORE_RL_bzlib_.dll',
             'lib/CORE_RL_GLIB_.DLL',
             'lib/CORE_RL_LCMS_.DLL',
             'lib/CORE_RL_lqr_.dll',
             'lib/CORE_RL_MagickWand_.dll',
             'lib/CORE_RL_TTF_.DLL',
             'lib/CORE_RL_zlib_.dll',
             'lib/LIBMAGICKCORE-6.Q16-2.DLL',
             ...
             'lib/libmatio-4.dll',
             'lib/libopenjp2.dll',
             'lib/libopenslide-0.dll',
             'lib/libpango-1.0-0.dll',
             'lib/libpangocairo-1.0-0.dll',
             'lib/libpangowin32-1.0-0.dll',
             'lib/libpixman-1-0.dll',
             'lib/libpng16-16.dll',
             'lib/libpoppler-63.dll',
             'lib/libpoppler-glib-8.dll',
             'lib/libquadmath-0.dll',
             'lib/librsvg-2-2.dll',
             'lib/libsqlite3-0.dll',
             'lib/libssp-0.dll',
             'lib/libstdc++-6.dll',
             'lib/libtiff-5.dll',
             'lib/libvips-42.dll',
             'lib/libvips-cpp-42.dll',
             'lib/libvipsCC-42.dll',
             'lib/libwebp-6.dll',
             'lib/libxml2-2.dll',
             'lib/zlib1.dll'
          ]
